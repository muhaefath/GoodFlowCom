...
<body>
    <div id="app">
        ...
        <main class="py-4">
                    ...
                    <form id="regForm" method ="POST" action="/bussinessman">
                              <h1>Data Barang:</h1>
                              <!-- One "tab" for each step in the form: -->
                              <div class="tab" >Data Gudang
                                ...
                                <div class="form-group row">
                                    <label for="Tanggal" class="col-md-4 col-form-label text-md-right">Tanggal Masuk Gudang</label>
                                    <div class="col-md-6">
                                        <input id="Tanggal" type="date" name="TanggalMasuk" required>
                                    </div>
                                </div>
                                <div class="form-group row">
